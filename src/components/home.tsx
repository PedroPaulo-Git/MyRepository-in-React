...
function Home() {
    return(
        <div  id="home">
            ...
            <Social/>
            <a className={styles.homebutton_link}  style={{textDecoration:"none"}} href="https://api.whatsapp.com/send?phone=8199049803&text=Olá,%20gostaria%20de%20entrar%20em%20contato." target="_blank">
